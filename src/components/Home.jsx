...
export default function Home(){ 
    ...
    return (
        ...
        <div className="setBackgroundImageHome">
            ...
            <p style={{width:'1000px'}}> We prioritize the sense of community. Communities can effortlessly post class requirements, and tutors can seamlessly connect with these opportunities, fostering collaboration and enriching educational experiences.</p>
            <p style={{width:'1000px',marginBottom:40}}>
